...
export const apiRot = config.siteM.concat(config.methodM)
export const apiRotL = config.siteM.concat(config.methodL)
export const apiRotR = config.siteR.concat(config.methodR)
export const apiRotMovie = config.siteM.concat(config.methodMovie)
export const h5Callback = config.siteM.concat(config.h5Callback)
